...
function UpdatedBookNowBottom() {
  ...
  return (
    <div className='fixed z-40 md:hidden bottom-0 flex items-center justify-center left-0 w-full bg-yellow-700'>
      <button
        onClick={openDrawer}
        className='bg-[#a65f00] py-2.5 text-white text-sm w-full text-center'
      >
        Enquire Now!
      </button>
...
export default UpdatedBookNowBottom;
