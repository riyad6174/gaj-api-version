...
export default function ResortPolicies() {
  return (
    <>
      <Head>
        <title>Resort Policies at Gaj Retreat | Terms & Conditions</title>
        <meta
          name='description'
          content='Review the Resort Policies at Gaj Retreat, Punjab, including check-in/check-out times, identity proof requirements, cancellation, refund, and group booking policies.'
        />
        <meta name='robots' content='index, follow' />
        {/* Open Graph Tags */}
        <meta
          property='og:title'
          content='Resort Policies at Gaj Retreat | Terms & Conditions'
        />
        <meta
        ...
        <meta
          property='og:url'
          content='https://www.gajretreat.com/resort-policies'
        />
        ...
        <link
          rel='canonical'
          href='https://www.gajretreat.com/resort-policies'
        />
      </Head>
      <NavbarHero />
