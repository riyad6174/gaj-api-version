  ...
  if (error || !pageData) {
    return (
      <div className='min-h-screen flex flex-col'>
        ...
        <NavbarHero />
        <div className='mt-20 font-mono flex-grow min-h-[600px] bg-gradient-to-br  flex items-center justify-center p-4'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full'>
            ...
            <div className='flex flex-col justify-center text-center md:text-left p-8  '>
              ...
              <p className='text-lg text-gray-500 mb-6'>
                {error ||
                  'Oops! The page you are looking for has wandered off.'}
              </p>
              <button
                onClick={() => router.push('/')}
                className='bg-[#553f26] font-sans text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#553f26] transition duration-300 ease-in-out transform hover:scale-105'
              >
                Return to Homepage
              </button>
            </div>
            {/* Right Side: Gaj Retreat Image */}
            <div className='flex items-center justify-center'>
              <img
                src='/assets/img/slider.jpg'
                alt='Gaj Retreat'
                className='rounded-xl shadow-xl max-w-full h-auto object-cover transform hover:scale-105 transition duration-300'
              />
            </div>
          </div>
        </div>
